...
$id=($_SESSION['id']);
$consulta="SELECT inventario.nombre_Inventario, pedidos.fecha_inicio_Pedidos, pedidos.hora_inicio_Pedidos, pedidos.hora_final_Pedidos, pedidos.id_Pedidos from inventario INNER JOIN pedidos ON pedidos.inventario_Pedidos=inventario.id_Inventario where inventario.estado_Inventario='1,2'AND inventario.tipo_Inventario='Proyector' AND pedidos.personal_Pedidos='$id' AND pedidos.finalizado=0 ";
$exe=mysqli_query($conn,$consulta);
if (mysqli_num_rows($exe)<1) {
	echo "<tr>";
	echo "<td class='centrartabla'><div style='margin-bottom:5%; margin-top:2%;'>No tienes proyectores reservados<td>";
	echo "</div>";	
}else{
